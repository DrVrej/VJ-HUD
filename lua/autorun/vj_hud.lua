...
hook.Add("HUDPaint", "vj_hud_localplayerinfo", function()
	...
	draw.SimpleText("#vjhud.ignoreply.on","VJFont_Trebuchet24_Tiny", 160, ScrH()-98, color(255, 255, 255, 150), 0, 0) else
	draw.SimpleText("#vjhud.ignoreply.off","VJFont_Trebuchet24_Tiny", 160, ScrH()-98, color(255, 255, 255, 150), 0, 0) end*/
	/*if GetConVarNumber("ai_serverragdolls") == 1 then
	draw.SimpleText("#vjhud.cropses.on","VJFont_Trebuchet24_Tiny", 160, ScrH()-90, color(255, 255, 255, 150), 0, 0) else
	draw.SimpleText("#vjhud.cropses.off","VJFont_Trebuchet24_Tiny", 160, ScrH()-90, color(255, 255, 255, 150), 0, 0) end*/
...
hook.Add("HUDPaint", "vj_hud_compass", function()
	...
	if ang >= -18 and ang <= 18 then
		comp_dir = "#vjhud.directions.N"
	elseif ang >= 162 and ang < 862 then
		comp_dir = "#vjhud.directions.S"
	elseif ang <= -162 and ang > -862 then
		comp_dir = "#vjhud.directions.S"
	elseif ang == 180 or ang == -862 then
		comp_dir = "#vjhud.directions.S"
	elseif ang >= 72 and ang <= 108 then
		comp_dir = "#vjhud.directions.W"
	elseif ang <= -72 and ang >= -108 then
		comp_dir = "#vjhud.directions.E"
	elseif ang > 18 and ang < 72 then
		comp_dir = "#vjhud.directions.NW"
	elseif ang > 108 and ang < 162 then
		comp_dir = "#vjhud.directions.SW"
	elseif ang < -18 and ang > -72 then
		comp_dir = "#vjhud.directions.NE"
	elseif ang < -108 and ang > -162 then
		comp_dir = "#vjhud.directions.SE"
	end
		...
		if (pos.visible) then
			...
			if ent:IsNPC() then -- NPC-ineroon hamar minag:
				...
				if npc_disp == 1 then
					...
					npc_disp_t = "#vjhud.npc.relationship.hostile"
				elseif npc_disp == 2 then
					npc_disp_color = color(255, 150, 0, 255)
					npc_disp_t = "#vjhud.npc.relationship.frightened"
				elseif npc_disp == 3 then
					npc_disp_color = color(0, 255, 0, 255)
					npc_disp_t = "#vjhud.npc.relationship.friendly"
				elseif npc_disp == 4 then
					npc_disp_color = color(255, 150, 0, 255)
					npc_disp_t = "#vjhud.npc.relationship.neutral"
				end
